...
{
    /// <inheritdoc />
    public partial class AddPOSDomainModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlertLimit = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 0)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ProductId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    MaterialId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products_Materials", x => new { x.ProductId, x.MaterialId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_Materials_MaterialId",
